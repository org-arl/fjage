...
const cjs_includes = [
  'const { Performative, AgentID, Message, Gateway, registerMessage, GenericMessage, JSONMessage, PutFileReq, GetFileReq, GetFileRsp, DeleteFileReq, ShellExecReq} = require(\'../../dist/cjs/fjage.cjs\');',
...
const esm_includes = [
  'import { Performative, AgentID, Message, Gateway, registerMessage, GenericMessage, JSONMessage, PutFileReq, GetFileReq, GetFileRsp, DeleteFileReq, ShellExecReq} from \'../../dist/esm/fjage.js\';',
