...
const cjs_includes = [
  'const { Performative, AgentID, Message, Gateway, MessageClass, registerMessageClass, GenericMessage, JSONMessage, PutFileReq, GetFileReq, GetFileRsp, ShellExecReq } = require(\'../../dist/cjs/fjage.cjs\');',
...
const esm_includes = [
  'import { Performative, AgentID, Message, Gateway, MessageClass, registerMessageClass, GenericMessage, JSONMessage, PutFileReq, GetFileReq, GetFileRsp, ShellExecReq} from \'../../dist/esm/fjage.js\';',
